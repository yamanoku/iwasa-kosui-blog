...
そこで、慌てて User-Agent ヘッダーの値をユーザ特定の条件として再度追跡を試しましたが、慌てていたこともあり図から何も読み取ることができませんでした。

![サンキー図にした結果](sankey-isucon10.png)

**反省**

ベンチマーカーは必ず `GET /api/estate/low_priced` エンドポイントを叩くことが競技後に分かりましたが、なんと上の図をよく見るとそれが読み取れたんですね...。焦りは禁物とはよくいいますが、人間は焦ってしまう生き物ですから、焦っている状態でもすぐ見てわかるような出力ができるツールにしたいと想います。いい感じになったら公開する予定です。
